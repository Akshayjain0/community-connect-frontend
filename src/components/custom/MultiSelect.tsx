			...
			>
				<PopoverTrigger asChild>
					<Button
						...
						className={cn(
							"flex w-full p-1 shadow-xs rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
							className
						)}
					>
